defmodule Authentication.MixProject do
  ...
  def project do
    [
      ...
      # Docs
      name: "Authentication",
      source_url: "https://github.com/Deankinyua/authentication",
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind authentication", "esbuild authentication"],
      "assets.deploy": [
        "tailwind authentication --minify",
        "esbuild authentication --minify",
        "phx.digest"
      ],
      ci: [
